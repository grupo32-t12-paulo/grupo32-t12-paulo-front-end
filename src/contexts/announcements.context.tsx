...
// interface IUser extends IHandleAnnouncementes, IUser {
...
const AnnouncementProvide = ({ children }: ICurrentAnnouncementsChildren) => {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaXNBY3RpdmUiOnRydWUsImlzQWR2ZXJ0aXNlciI6dHJ1ZSwiaWF0IjoxNjc3NzM2MzU5LCJleHAiOjE2Nzc4MjI3NTksInN1YiI6IjEifQ.oJIuZ_zRjO6H7WRWaUy3GQcoj-ruoh9WOcIqFMrPTlM"
